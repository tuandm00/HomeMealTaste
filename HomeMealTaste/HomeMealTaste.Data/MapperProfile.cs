...
namespace HomeMealTaste.Data.RequestModel
{
    public class MapperProfile : Profile
    {
        public MapperProfile()
        {
            ...
            CreateMap<GetAllSessionByAreaIdResponseModel, SessionArea>().ReverseMap();
            ...
            CreateMap<GetSingleAreaByAreaIdResponseModel, Area>().ReverseMap();
            CreateMap<SessionForChangeStatusRequestModel, Session>().ReverseMap();
            CreateMap<UpdateStatusMeallSessionRequestModel, MealSession>().ReverseMap();
            CreateMap<UpdateSessionAndAreaInSessionRequestModel, Session>().ReverseMap();
            CreateMap<UpdateSessionAndAreaInSessionResponseModel, Session>().ReverseMap();
            CreateMap<UpdateDishTypeRequestModel, DishType>().ReverseMap();
            CreateMap<UpdateDishTypeResponseModel, DishType>().ReverseMap();
            CreateMap<GetAllAreaBySessionIdResponseModel, Area>().ReverseMap();
            CreateMap<ChangeStatusRegisterForMealRequestModel, Session>().ReverseMap();
            CreateMap<ChangeStatusBookingSlotRequestModel, Session>().ReverseMap();
            CreateMap<ChangeStatusSessionRequestModel, Session>().ReverseMap();
            CreateMap<UpdateDistrictRequestModel, District>().ReverseMap();
            ...
            CreateMap<ChangeStatusOrderResponseModel, Order>().ReverseMap();
            CreateMap<GetSingleSessionAreaByAreaIdResponseModel, SessionArea>().ReverseMap();
